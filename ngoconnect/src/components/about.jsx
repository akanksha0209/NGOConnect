    ...
    <div className="container-fluid fixed-top px-0 wow fadeIn" data-wow-delay="0.1s">
        <div className="top-bar text-white-50 row gx-0 align-items-center d-none d-lg-flex">
            ...
            <div className="col-lg-6 px-5 text-end">
                ...
                <a classNameName="text-white-50 ms-3" href="https://www.facebook.com/"><i classNameName="fab fa-facebook-f"></i></a>
                <a classNameName="text-white-50 ms-3" href="https://twitter.com/"><i classNameName="fab fa-twitter"></i></a>
                <a classNameName="text-white-50 ms-3" href="https://in.linkedin.com/"><i classNameName="fab fa-linkedin-in"></i></a>
                <a classNameName="text-white-50 ms-3" href="https://www.instagram.com/"><i classNameName="fab fa-instagram"></i></a>
            </div>
        </div>
        ...
        <div className="container text-center">
            ...
            <nav aria-label="breadcrumb animated slideInDown">
                <ol className="breadcrumb justify-content-center mb-0">
                    <li className="breadcrumb-item"><a className="text-white" href="https://www.google.co.in/">Home</a></li>
                    <li className="breadcrumb-item"><a className="text-white" href="https://www.google.co.in/">Pages</a></li>
            ...
            <div className="row g-5">
                <div className="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div className="position-relative overflow-hidden h-100" style={{minHeight: "400px"}}>
                        <img className="position-absolute w-100 h-100 pt-5 pe-5" src="assets/img/about-1.jpg" alt="" style={{objectFit: "cover"}}/>
            ...
            <div className="row g-4 justify-content-center">
                <div className="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div className="service-item bg-white text-center h-100 p-4 p-xl-5">
                        <img className="assets/img-fluid mb-4" src="img/icon-1.png" alt=""/>
                ...
                <div className="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div className="team-item position-relative rounded overflow-hidden">
                        <div className="overflow-hidden">
                            <img className="assets/img-fluid" src="img/team-1.jpg" alt=""/>
                        </div>
