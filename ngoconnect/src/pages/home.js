...
class Home extends React.Component{
    ...
    */}
        ...
        <nav className="navbar navbar-expand-lg navbar-dark py-lg-0 px-lg-5 wow fadeIn" data-wow-delay="0.1s">
            ...
            <div className="collapse navbar-collapse" id="navbarCollapse">
                ...
                <div className="d-none d-lg-flex ms-2">
                    <a className="btn btn-outline-primary py-2 px-3" href="https://www.google.co.in/">
                        Donate Now
                        ...
                        <div className="container">
                            <div className="row justify-content-center">
                                <div className="col-lg-7 pt-5">
                                    ...
                                    <a className="btn btn-primary py-2 px-3 animated slideInDown" href="https://www.google.co.in/">
                                        Learn More
                                        <div className="d-inline-flex btn-sm-square bg-white text-primary rounded-circle ms-2">
                                            <i className="fa fa-arrow-right"></i>
                                        </div>
                ...
                <div className="carousel-item">
                    ...
                    <div className="carousel-caption">
                        <div className="container">
                            <div className="row justify-content-center">
                                <div className="col-lg-7 pt-5">
                                    <h1 className="display-4 text-white mb-3 animated slideInDown">Let's Save More Lifes With Our Helping Hand</h1>
                                    <p className="fs-5 text-white-50 mb-5 animated slideInDown">Aliqu diam amet diam et eos. Clita erat ipsum et lorem sed stet lorem sit clita duo justo erat amet</p>
                                    <a className="btn btn-primary py-2 px-3 animated slideInDown" href="https://www.google.co.in/">
                                        Learn More
                                        <div className="d-inline-flex btn-sm-square bg-white text-primary rounded-circle ms-2">
            ...
            <div className="row g-5">
                <div className="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <div className="position-relative overflow-hidden h-100" style={{minHeight:"400px"}}>
                        <img className="position-absolute w-100 h-100 pt-5 pe-5" src="assets/img/about-1.jpg" alt="" style={{"object-fit": "cover"}} />
                        <img className="position-absolute top-0 end-0 bg-white ps-2 pb-2" src="assets/img/about-2.jpg" alt="" style={{width: "200px", height: "200px"}} />
                    </div>
                </div>
                <div className="col-lg-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div className="h-100">
                        ...
                        <a className="btn btn-primary py-2 px-3 me-3" href="https://www.google.co.in/">
                            Learn More
                            <div className="d-inline-flex btn-sm-square bg-white text-primary rounded-circle ms-2">
                                <i className="fa fa-arrow-right"></i>
                            </div>
                    ...
                    <div className="causes-item d-flex flex-column bg-white border-top border-5 border-primary rounded-top overflow-hidden h-100">
                        ...
                        <div className="position-relative mt-auto">
                            ...
                            <div className="causes-overlay">
                                <a className="btn btn-outline-primary" href="https://www.google.co.in/">
                                    Read More
                                    <div className="d-inline-flex btn-sm-square bg-primary text-white rounded-circle ms-2">
                                        <i className="fa fa-arrow-right"></i>
                                    </div>
            ...
            <div className="row g-4 justify-content-center">
                <div className="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div className="service-item bg-white text-center h-100 p-4 p-xl-5">
                        ...
                        <a className="btn btn-outline-primary px-3" href="https://www.google.co.in/">
                            Learn More
                            <div className="d-inline-flex btn-sm-square bg-primary text-white rounded-circle ms-2">
                                <i className="fa fa-arrow-right"></i>
                            </div>
    ...
    <div className="container-fluid donate my-5 py-5" data-parallax="scroll" data-image-src="assets/img/carousel-2.jpg">
        <div className="container py-5">
            <div className="row g-5 align-items-center">
                <div className="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
                    ...
                    <p className="text-white-50 mb-0">Tempor erat elitr rebum at clita. Diam dolor diam ipsum sit. Aliqu diam amet diam et eos. Clita erat ipsum et lorem et sit, sed stet lorem sit clita duo justo magna dolore erat amet</p>
                </div>
                    ...
                    <div className="team-item position-relative rounded overflow-hidden">
                        ...
                        <div className="team-text bg-light text-center p-4">
                            ...
                            <div className="team-social text-center">
                                <a className="btn btn-square" href="https://www.google.co.in/"><i className="fab fa-facebook-f"></i></a>
                                <a className="btn btn-square" href="https://www.google.co.in/"><i className="fab fa-twitter"></i></a>
                                <a className="btn btn-square" href="https://www.google.co.in/"><i className="fab fa-instagram"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div className="container">
            ...
            <div className="owl-carousel testimonial-carousel wow fadeInUp" data-wow-delay="0.1s">
                <div className="testimonial-item text-center">
                    <img className="img-fluid bg-light rounded-circle p-2 mx-auto mb-4" alt="" src="assets/img/testimonial-1.jpg" style={{width: "100px", height: "100px"}}/>
                ...
                <div className="testimonial-item text-center">
                    <img className="img-fluid bg-light rounded-circle p-2 mx-auto mb-4" alt="" src="assets/img/testimonial-2.jpg" style={{width: "100px", height: "100px"}}/>
                    <div className="testimonial-text rounded text-center p-4">
                        <p>Clita clita tempor justo dolor ipsum amet kasd amet duo justo duo duo labore sed sed. Magna ut diam sit et amet stet eos sed clita erat magna elitr erat sit sit erat at rebum justo sea clita.</p>
                        <h5 className="mb-1">Doner Name</h5>
                        <span className="fst-italic">Profession</span>
                ...
                <div className="testimonial-item text-center">
                    <img className="img-fluid bg-light rounded-circle p-2 mx-auto mb-4" alt="" src="assets/img/testimonial-3.jpg" style={{width: "100px", height: "100px"}}/>
                    <div className="testimonial-text rounded text-center p-4">
                        <p>Clita clita tempor justo dolor ipsum amet kasd amet duo justo duo duo labore sed sed. Magna ut diam sit et amet stet eos sed clita erat magna elitr erat sit sit erat at rebum justo sea clita.</p>
                        <h5 className="mb-1">Doner Name</h5>
                        <span className="fst-italic">Profession</span>
            ...
            <div className="row g-5">
                <div className="col-lg-3 col-md-6">
                    ...
                    <div className="d-flex pt-2">
                        ...
                        <a className="btn btn-square me-1" href="https://www.google.co.in/"><i className="fab fa-facebook-f"></i></a>
                        <a className="btn btn-square me-1" href="https://www.google.co.in/"><i className="fab fa-youtube"></i></a>
                        <a className="btn btn-square me-0" href="https://www.google.co.in/"><i className="fab fa-linkedin-in"></i></a>
                    </div>
                </div>
                <div className="col-lg-3 col-md-6">
                ...
                <div className="col-lg-3 col-md-6">
                    ...
                    <a className="btn btn-link" href="https://www.google.co.in/">About Us</a>
                    <a className="btn btn-link" href="https://www.google.co.in/">Contact Us</a>
                    <a className="btn btn-link" href="https://www.google.co.in/">Our Services</a>
                    <a className="btn btn-link" href="https://www.google.co.in/">Terms & Condition</a>
                    <a className="btn btn-link" href="https://www.google.co.in/">Support</a>
                </div>
                <div className="col-lg-3 col-md-6">
            ...
            <div className="container">
                <div className="row">
                    <div className="col-md-6 text-center text-md-start mb-3 mb-md-0">
                        &copy; <a href="https://www.google.co.in/">Your Site Name</a>, All Right Reserved.
                    </div>
    ...
    <a href="https://www.google.com/" className="btn btn-lg btn-primary btn-lg-square back-to-top"><i className="bi bi-arrow-up"></i></a>
